...
{
    private static string FullAzure(bool slotSetting0 = false, bool slotSetting1 = false)
    {
        return @"[
  {
    ""name"": ""!Key3"",
  ...
  },
  {
    ...
    public async Task Convert_Azure_MainDev()
    {
        ...
        Assert.Equal(AppSettingConversionTest.FullAzure(), string.Join(Environment.NewLine, result));
    }
    ...
    public async Task Convert_Azure_MainDev_SlotSetting()
    {
        ...
        Assert.Equal(AppSettingConversionTest.FullAzure(true, false), string.Join(Environment.NewLine, result));
    }
    ...
    public async Task Convert_Azure_MainDev_SlotSetting2()
    {
        ...
        Assert.Equal(AppSettingConversionTest.FullAzure(false, true), string.Join(Environment.NewLine, result));
    }
    ...
    public async Task Convert_Azure_MainDev_SlotSetting3()
    {
        ...
        Assert.Equal(AppSettingConversionTest.FullAzure(true, true), string.Join(Environment.NewLine, result));
    }
